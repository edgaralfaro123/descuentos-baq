        ...
        items.map(item =>(
          <div className='col-sm-3' key={item.codigo}>
            <div style={styles.well}>
              <img className="card-img-top" src={item.urlimagen} alt="Card image cap" style={{borderRadius: "25px",paddingTop: "10px",backgroundColor:'white'}}/>
              ...
              <div className="card-body" >
                ...
                <a href="" className="btn btn-sm float-right" style={{background:'#5b4f6c',color:'white'}}>Visitar</a>
